...
const productValidation = [
  ...
  body("wastage").notEmpty().isFloat({ min: 0 }).withMessage("Wastage must be at least 0"),
  body("polish").notEmpty().isFloat({ min: 0 }).withMessage("Polish must be at least 0"),
  ...
  body("weightValue").notEmpty().isFloat({ min: 0 }).withMessage("Weight must be greater than 0"),
